...
- **`https://tabs.marce1in.com.br` fora do ar**: o servidor roda no homelab do Marcelo (um notebook velho), então provavelmente ele deixou o notebook desligar. Nesse caso, chame o Marcelo no WhatsApp ou rode o backend localmente seguindo o [README do backend](https://github.com/Marce1in/backs_backs_backs).
